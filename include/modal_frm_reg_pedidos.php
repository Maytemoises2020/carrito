...
<div class="modal fade registrar" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
       <div class="modal-content">
           ...
           <form action="operaciones/registrarPedidos.php" method="POST">
                                ...
                                <div class="form-group row">
                                    ...
                                    <input type="number" name="monto"class="form-control col-lg-7 col-md-10 col-sm-12" required>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <input type="text" name="estado"class="form-control col-lg-7 col-md-10 col-sm-12" required>
                                </div>
